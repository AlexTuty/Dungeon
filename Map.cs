...
namespace Dungeon
{
	public class Map
	{
		...
		/// <summary>
		/// ќпредел€ет принадлежность точки игровому полю
		/// </summary>
		/// <param name="point">“очка принадлежность которой необходимо вы€снить</param>
		/// <returns>¬озвращает true если точка принадлежит игровому полю иначе false</returns>
