...
namespace Dungeon
{
    ...
    {
        [Test, Order(0)]
        public void ReturnNoPaths_WhenNoPathsToChests() // Не возвращать пути, когда нет путей к сундукам
        {
            var textMap = new[]
            {
                "P ",
        ...
        [Test, Order(1)]
        public void ReturnCorrectPaths_OnEmptyDungeon() // Возврат правильных путей в пустом подземелье
        {
            var textMap = new[]
            {
                "P ",
        ...
        [Test, Order(2)]
        public void ReturnCorrectPaths_OnSimpleDungeon() // Возврат правильных путей в простое подземелье
        {
            var textMap = new[]
            {
                "P #",
        ...
        [Test, Order(6)]
        public void Return_ShortestPaths_OnBigTestDangeon() // Возврат кратчайших путей на большой тест Dangeon
        {
        ...
        [Test, Order(7)]
        public void WorksCorrect_ShortestPaths_OnManyCalls() // Корректирует кратчайшие пути при многих вызовах
        {
